...
theme.set_highlights = function()
  ...
  hl(0, "PmenuSel", { fg = c.purple, bg = c.background })
  ...
  hl(0, "CmpItemKindText", { fg = c.green, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindKeyword", { fg = c.yellow, bg = 'NONE' })
  hl(0, "CmpItemKindConstructor", { fg = c.yellow, bg = 'NONE' })
  hl(0, "CmpItemKindClass", { fg = c.yellow, bg = 'NONE' })
  hl(0, "CmpItemKindEnum", { fg = c.darkyellow, bg = 'NONE' })
  hl(0, "CmpItemKindEvent", { fg = c.cyan, bg = 'NONE' })
  ...
  hl(0, "CmpItemKindTypeParameter", { fg = c.yellow, bg = 'NONE' })
