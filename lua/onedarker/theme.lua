...
theme.set_highlights = function()
  ...
  hl(0, "BufferLineCloseButtonSelected", { fg = c.red, bg = c.alt_bg })
  hl(0, "BufferLineCloseButtonVisible", { fg = c.comment_grey, bg = 'NONE' })
  hl(0, "BufferLineFill", { fg = c.alt_bg, bg = c.alt_bg })
  ...
  hl(0, "BufferLineBufferSelected", { fg = c.alt_bg, bg = c.bg })
